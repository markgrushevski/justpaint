/**
 * Ported from the legacy justpaint icons.ts (@mdi/js path strings), rendered via
 * OriButton's `icon` prop / inline `<svg fill="currentColor">`.
 */
export const icons = {
