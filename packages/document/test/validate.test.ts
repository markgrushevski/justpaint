...
describe('validateDocument', () => {
    const valid: Array<[string, unknown]> = [
        ...
        [
            'shape stroke can erase (destination-out)',
            docWith({
                id: 's',
                type: 'rect',
                composite: 'destination-out',
        ...
        [
            'explicit null background is allowed',
            {
                version: 1,
                width: 10,
                height: 10,
    ...
    const invalid: Array<[string, unknown]> = [
        ...
        [
            'layer opacity out of range',
            {
                ...
                height: 10,
                background: null,
                layers: [{ id: 'l', name: 'L', visible: true, opacity: 1.5, strokes: [] }]
            }
        ],
        [
            'duplicate id',
        ...
        [
            'bad composite',
            docWith({ id: 's', type: 'rect', composite: 'xor', x: 0, y: 0, width: 10, height: 10, fill: '#000000' })
        ],
        [
            'freehand zero points',
            docWith({
                id: 's',
                type: 'freehand',
                composite: 'source-over',
        ...
        [
            'freehand pressure out of range',
            docWith({
                id: 's',
                type: 'freehand',
                composite: 'source-over',
        ...
        [
            'ellipse zero radius',
            docWith({ id: 's', type: 'ellipse', composite: 'source-over', cx: 5, cy: 5, rx: 0, ry: 5, fill: '#000000' })
        ],
        [
            'polygon under three vertices',
            docWith({
                id: 's',
                type: 'polygon',
                composite: 'source-over',
        ...
        [
            'shape strokeWidth zero with stroke present',
            docWith({
                id: 's',
                type: 'rect',
                composite: 'source-over',
        ...
        [
            'freehand point wrong arity (2 elems)',
            docWith({
                id: 's',
                type: 'freehand',
                composite: 'source-over',
        ...
        [
            'line point wrong arity (3 elems)',
            docWith({
                id: 's',
                type: 'line',
                composite: 'source-over',
        ...
        [
            'missing layer visible',
            {
                version: 1,
                width: 10,
                height: 10,
                background: null,
                layers: [{ id: 'l', name: 'L', opacity: 1, strokes: [] }]
            }
        ],
        [
            'missing layer opacity',
            {
                version: 1,
                width: 10,
                height: 10,
                background: null,
                layers: [{ id: 'l', name: 'L', visible: true, strokes: [] }]
            }
        ],
        [
            'missing layer strokes',
            {
                version: 1,
                width: 10,
                height: 10,
                background: null,
                layers: [{ id: 'l', name: 'L', visible: true, opacity: 1 }]
            }
        ],
        [
