 ...
 */
export function zoomAround(view: ViewState, factor: number, centerX: number, centerY: number): ViewState {
...
export function zoomTo(view: ViewState, zoom: number, centerX: number, centerY: number): ViewState {
