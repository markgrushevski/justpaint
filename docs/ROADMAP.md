...
- [~] **Tests** — Go validator: table-driven tests done (a valid full document + every rejection path + union decode, `internal/document`). TS document round-trip tests come with `packages/document`.
