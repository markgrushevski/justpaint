...
import type { ToolbarItem } from '@shared/types';
import { computed } from 'vue';
import WrapperIcon from './WrapperIcon.vue';

const p = defineProps<{ type: ToolbarItem; isActive?: boolean }>();

const capitalizedType = computed(() => {
    return p.type[0].toUpperCase() + p.type.substring(1);
});
</script>
...
<template>
    <WrapperIcon
        class="toolbar__icon"
        :class="{ toolbar__icon_active: isActive }"
    ...
    >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <defs>
                <path id="square" d="M3,3H21V21H3V3M5,5V19H19V5H5Z" />
                <path
                    id="save"
                ...
                />
                <path id="line" d="M15,3V7.59L7.59,15H3V21H9V16.42L16.42,9H21V3M17,5H19V7H17M5,17H7V19H5" />
                <path
                    id="eraser"
                ...
                />
                <path id="triangle" d="M12,2L1,21H23M12,6L19.53,19H4.47" />
            </defs>
            <use :href="`#${type}`"></use>
        </svg>
    </WrapperIcon>
