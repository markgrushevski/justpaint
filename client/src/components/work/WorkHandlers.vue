...
import { useWorkStore } from '@shared/stores'
import WorkHandler from './WorkHandler.vue'

const workStore = useWorkStore()

const workHandlerNamesBySVGPathValues: Record<string, string> = {
...
<template>
    <WorkHandler
        v-for="workHandler in workStore.workHandlers"
        :key="workHandler"
        :title="workHandler"
        :icon-path-value="workHandlerNamesBySVGPathValues[workHandler]"
    />
</template>
